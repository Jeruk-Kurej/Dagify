...
struct POSViewModelTests {
    ...
    @Test @MainActor func testCartManagement() async throws {
        ...
        let vm = POSViewModel(repo: mockRepo)
    ...
    @Test @MainActor func testCheckoutSuccessfully() async throws {
        ...
        #expect(mockRepo.submitCallCount == 1) // Memastikan Repository dieksekusi
    }
}
...
struct InventoryViewModelTests {
    ...
    @Test @MainActor func testInventoryWarnings() async throws {
        ...
        mockRepo.dummyIngredients = [
            ...
            Ingredient(id: "I-1", name: "Gula", currentStock: 1000, unit: "Gr", expiryDate: nextMonth, minimumStockWarning: 200),
            
            // 2. Stok Menipis (Low Stock), Belum Basi
            Ingredient(id: "I-2", name: "Susu", currentStock: 100, unit: "Ml", expiryDate: nextMonth, minimumStockWarning: 500),
            
            // 3. Stok Aman, Tapi Basi (Expired)
            Ingredient(id: "I-3", name: "Roti", currentStock: 50, unit: "Pcs", expiryDate: yesterday, minimumStockWarning: 10)
        ]
