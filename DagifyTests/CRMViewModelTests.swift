...
struct CRMViewModelTests {
    ...
    func testLoadCustomersSuccess() async {
        ...
        let c2 = Customer(id: "2", storeId: "S-1", branchId: "B-1", name: "Siti", phoneNumber: "082", totalSpent: 5000, visitHistory: [Date(), Date()])
    ...
    func testGetCustomerCount() async {
        ...
        let c1 = Customer(id: "1", storeId: "S-1", branchId: "B-1", name: "Budi", phoneNumber: "081", totalSpent: 10000, visitHistory: [Date(), Date(), Date(), Date(), Date()])
        let c2 = Customer(id: "2", storeId: "S-1", branchId: "B-1", name: "Siti", phoneNumber: "082", totalSpent: 5000, visitHistory: [Date(), Date()])
        let c3 = Customer(id: "3", storeId: "S-1", branchId: "B-1", name: "Agus", phoneNumber: "083", totalSpent: 20000, visitHistory: Array(repeating: Date(), count: 10))
