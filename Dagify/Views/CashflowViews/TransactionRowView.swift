    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                .lineLimit(1)  // ✅ Batasi tepat 1 baris
                .truncationMode(.tail)  // ✅ Potong dengan "..." jika kepanjangan
            ...
            Text(
                "\(record.type == .income ? "+" : "-") \(record.amount.toRupiah())"
            )
            .font(.headline)
            .fontWeight(.bold)
            .foregroundColor(
        ...
        .padding(.vertical, 12)
        .contentShape(Rectangle())  // ✅ Agar seluruh area baris bisa di-tap
    }
}
